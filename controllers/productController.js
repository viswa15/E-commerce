...
export const productPhotoController = async(req,res) =>{
    try{
        ...
        res.status(500).send({
            success : false,
            message : "Error occuring during retrieval of photo",
            e
        })
    }
}
...
export const deleteProductController = async(req,res) =>{
    try{
        ...
        res.status(500).send({
            success : false,
            message : "Error during deleting a product",
            e
        })
    }
}
...
//payments
export const braintreePaymentContoller = async(req,res) =>{
    try{
